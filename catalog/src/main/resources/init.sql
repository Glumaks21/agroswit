...
(
    ...
    constraint category_name_parent_cat_id_uk unique (companyName, parent_category_id)
);
...
(
    ...
    constraint cat_prop_group_name_cat_id_uk unique (companyName, category_id)
);
...
(
    ...
    constraint cat_prop_name_gr_id_uk unique (companyName, group_id)
);
...
(
    ...
    constraint prod_prop_group_name_prod_id_uk unique (product_id, companyName)
);
...
(
    ...
    constraint product_prop_group_name_uk unique (group_id, companyName)
);
...
alter table product_packages
    add constraint product_pckgs_old_price_constr check ( old_price > 0 );
alter table product_packages
