...
public class ProducerServiceImpl implements ProducerService {
    ...
    @Override
    @Transactional
    public ProducerDTO saveLogoById(Integer producerId, MultipartFile logo) {
        ...
        var saveProducer = producerRepo.save(producer);

        return mapper.toDTO(saveProducer, uploadService.getUrl(saveProducer.getLogo()));
    }
