...
public class ProductController {
    ...
    ProductDTO create(@RequestBody @Validated(Groups.Create.class) ProductModifiableDTO dto) {
    ...
    @ResponseStatus(CREATED)
    @PostMapping(path = "/{id}/image", consumes = MULTIPART_FORM_DATA_VALUE, produces = APPLICATION_JSON_VALUE)
    ...
    ProductDTO update(@PathVariable Integer id,
                              @RequestBody @Validated(Groups.FullUpdate.class) ProductModifiableDTO dto) {
        log.info("Received product updating request with dto: {}", dto);
