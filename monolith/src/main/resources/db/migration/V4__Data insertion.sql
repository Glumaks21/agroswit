INSERT INTO producer(companyName, logo)
...
INSERT INTO category(companyName)
VALUES ('Засоби захисту рослин'),
       ('Насіння'),
       ('Мікродобрива');

INSERT INTO category(companyName, parent_category_id)
VALUES ('Гербіциди', 1),
       ('Фунгіциди', 1),
       ('Соняшник', 2),
       ('Кукуруза', 2),
...
INSERT INTO category_properties(category_id, companyName)
VALUES (3, 'олійність'),
       (4, 'висота'),
       (3, 'місце збирання'),
       (3, 'група стиглосты'),
...
INSERT INTO product(companyName, producer_id, volume, unit, category_id, article_1c_id)
...
INSERT INTO product_properties(product_id, companyName, value)
...
INSERT INTO user_info(user_id, companyName, surname, patronymic)
